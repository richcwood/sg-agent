  ...
  async getQueues(matchStr: string) {
    return new Promise((resolve, reject) => {
      this.instance
        ...
        .catch((err) => {
          reject(
            new Error(`Error getting queues matching '${matchStr}': ${err}`)
          );
        });
    });
  }
  ...
  async getExchanges(matchStr: string) {
    return new Promise((resolve, reject) => {
      this.instance
        ...
        .catch((err) => {
          reject(
            new Error(`Error getting exchanges matching '${matchStr}': ${err}`)
          );
        });
    });
  }
      ...
      this.instance
        ...
        .then((response) => {
          this.instance
            ...
            .catch((err) => {
              reject(
                new Error(`Error setting '${userName}' permissions: ${err}`)
              );
            });
        })
        .catch((err) => {
  ...
  async getUsers(matchStr: string) {
    return new Promise((resolve, reject) => {
      this.instance
        ...
        .catch((err) => {
          reject(
            new Error(`Error getting users matching '${matchStr}': ${err}`)
          );
        });
    });
  }
